''' Задача 6_1.  Сделать игру морской бой с использованием функций'''

from random import randint


def create_sea_dimens(diag):            # Функция генерации пустого поля
    created_list = [[0 for j in range(diag)] for i in range(diag)]
    return created_list


def print_sea_dimens(any_matrix):       # Функция вывода поля боя в консоль
...
def play_progress():                    # Функция Game_Play
